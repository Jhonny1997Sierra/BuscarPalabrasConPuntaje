...
public class BuscarPalabrasConPuntaje {
    ...
    public static void main(String[] args) {
        // Paso 1: Solicitar al usuario la cantidad de palabras que desea buscar.
        ...
        // Paso 2: Leer el archivo .txt que contiene las palabras y sus puntajes.
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("palabras.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length == 2) {
                    String palabra = partes[0].toLowerCase(); // Convertir la palabra a minúsculas
        ...
        // Paso 3: Buscar las palabras solicitadas por el usuario y mostrar su puntaje.
        int sumaPuntajes = 0;
